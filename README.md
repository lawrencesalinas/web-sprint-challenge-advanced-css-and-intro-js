...
1. How would you describe acessibility on the web to someone new to programming? accessibility in programming is making my websites usable by as many people as possible
2. Talk about 3 different things you can do to ensure your website is accessible. better color usage, responsive webpage and use semantics.
3. How would you explain the concept of a variable to someone new to programming? variable is a container of a data.
